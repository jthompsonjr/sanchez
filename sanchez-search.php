...
<link rel=stylesheet type="text/css" href="http://legacy.lib.utexas.edu/photodraw/sanchez/sanchez.css">
</head>
...
<a href="http://legacy.lib.utexas.edu/photodraw/sanchez/">
<img src="http://legacy.lib.utexas.edu/photodraw/sanchez/images/title.gif" width="428" height="53" border="0"alt="Digitization of the George I. Sánchez Papers"></a>
</td>
</tr>
<tr>
...
<table bgcolor="#E8DABD" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr>
  <td rowspan="2"><img src="http://legacy.lib.utexas.edu/photodraw/sanchez/images/space.gif" alt="" width="10" height="4" border="0"></td>
  <td><img src="http://legacy.lib.utexas.edu/photodraw/sanchez/images/space.gif" alt="" width="1" height="4" border="0"></td>
 </tr>
 <tr>
  <td bgcolor="#E8DABD">
 ...
 <tr>
  <td colspan="2" bgcolor="#65372F">
  <img src="http://legacy.lib.utexas.edu/photodraw/sanchez/images/space.gif" alt="" width="1" height="2" border="0"><br>
  <span class="tablehead">&nbsp;keyword search</span><br>
  </td>
 </tr>
 <tr>
<td rowspan="3"><img src="http://legacy.lib.utexas.edu/photodraw/sanchez/images/space.gif" alt="" width="1" height="4" border="0"></td>
<td><img src="http://legacy.lib.utexas.edu/photodraw/sanchez/images/space.gif" alt="" width="1" height="6" border="0"></td>
</tr>
...
<img src="http://legacy.lib.utexas.edu/photodraw/sanchez/images/space.gif" alt="" width="1" height="4" border="0"><br>
...
/* Force json response from this script */
...
/* sidestep the offending solr client function */
$rawresults = $query_response->getRawResponse();
/* turn response into json object */
$jsonresults = json_decode($rawresults);
$newobj = 'SolrObject';
/* recast as solr object so remaining code will function */
$results = casttoclass($newobj, $jsonresults);
